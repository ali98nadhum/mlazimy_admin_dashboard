...
const DeleteSubcategoryForm = () => {
    ...
    const {deleteSubcategory} = useStore((state) => ({
  ...
  return (
    <div>
      <Dialog open={showConfirmation}>
        <DialogTitle sx={{fontFamily:'Almarai'}}>هل تريد حذف المحاضره ؟</DialogTitle>
        <DialogContent>
          <DialogContentText sx={{fontFamily:'Almarai'}}>
            هل أنت متأكد أنك تريد حذف هذه المحاضره ؟ لا يمكن التراجع عن هذا الإجراء.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
